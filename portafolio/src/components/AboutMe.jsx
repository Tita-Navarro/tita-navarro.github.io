        ...
        <div id='AboutMe' className='About container-fluid'>
            <div className='About-container'>
                <div className='About-brand'>
                    <br/> <br/> <br/>
                    <img src={require('../images/Castelnav.png')} alt='brand' className='mx-auto d-block 
                    img-fluid resp_img'/><br/>
                    ...
                    <div className='About-Skills container'>
                        <div className='row'>
                            ...
                            <div className='col-md About-container-icon'>
                                ...
                                <span className='devicon-photoshop-line colored About-iconskill'></span> 
                                <br/> <br/>
